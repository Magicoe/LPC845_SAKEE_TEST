...
#ifndef __DRIVER_SPI_SDCARD_H__
#define __DRIVER_SPI_SDCARD_H__
...
#define SDCARD_CS_CON        IOCON_PIO0_22  
#define SDCARD_CS_PRT        0
#define SDCARD_CS_PIN        22
#define SDCARD_CS_NUM        22

#define SDCARD_CK_CON        IOCON_PIO0_15  
#define SDCARD_CK_PRT        0
#define SDCARD_CK_PIN        15
#define SDCARD_CK_NUM        15

#define SDCARD_MI_CON        IOCON_PIO0_26 
#define SDCARD_MI_PRT        0
#define SDCARD_MI_PIN        26
#define SDCARD_MI_NUM        26

#define SDCARD_MO_CON        IOCON_PIO0_27  
#define SDCARD_MO_PRT        0
#define SDCARD_MO_PIN        27
#define SDCARD_MO_NUM        27

#define SDCARD_IN_CON        IOCON_PIO1_10  
#define SDCARD_IN_PRT        1
#define SDCARD_IN_PIN        10
#define SDCARD_IN_NUM        0x2A

#define SDCARD_SPI          LPC_SPI1

#define SDCARD_CS_SET()     Chip_GPIO_SetPinOutHigh(LPC_GPIO, SDCARD_CS_PRT, SDCARD_CS_NUM)
#define SDCARD_CS_CLR()     Chip_GPIO_SetPinOutLow (LPC_GPIO, SDCARD_CS_PRT, SDCARD_CS_NUM)
...
#define kStatusGroup_SDSPI              22                  /*!< Group number for SDSPI status codes. */
