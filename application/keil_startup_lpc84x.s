;/*****************************************************************************
; * @file:    startup_LPC84X.s
; * @purpose: CMSIS Cortex-M0+ Core Device Startup File 
; *           for the NXP LPC84X Device Series 
; * @version: V1.0
; * @date:    16. Aug. 2012
...
__Vectors       DCD     __initial_sp              ; Top of Stack
                ...
                DCD     PIN_INT5_IRQHandler         ; PIO INT5/DAC1
                DCD     PIN_INT6_IRQHandler         ; PIO INT6/UART3
                DCD     PIN_INT7_IRQHandler         ; PIO INT7/UART4
...
; now, under COMMON lpc84x_nmi.c and lpc84x_nmi.h, a real NMI handler is created if NMI is enabled 
