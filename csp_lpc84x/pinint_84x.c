/*
 * @brief LPC84X Pin Interrupt and Pattern Match driver
 *
 * @note
        ...
        Chip_PININT_BITSLICE_CFG_T slice_cfg, bool end_point)
{
	...
	if (end_point == true) {
		...
		NVIC_DisableIRQ((IRQn_Type)(PININT0_IRQn + sliceNum));
		NVIC_ClearPendingIRQ((IRQn_Type)(PININT0_IRQn + sliceNum));
