...
#ifndef __GPIO_84X_H_
#define __GPIO_84X_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup GPIO_84X CHIP: LPC8xx GPIO driver
...
typedef struct {				/*!< GPIO_PORT Structure */
	__IO uint8_t B[1][29];	/*!< Offset 0x0000: Byte pin registers ports 0 to n; pins PIOn_0 to PIOn_31 */
       uint8_t  Reserved1A[1][3];
       uint8_t  Reserved1B[127][32];
	__IO uint32_t W[1][29];	/*!< Offset 0x1000: Word pin registers port 0 to n */
       uint32_t  Reserved2A[1][3];
       uint32_t  Reserved2B[31][32];
	__IO uint32_t DIR[1];		/*!< Offset 0x2000: Direction registers port n */
       uint32_t  Reserved3[31];
	__IO uint32_t MASK[1];		/*!< Offset 0x2080: Mask register port n */
       uint32_t  Reserved4[31];
	__IO uint32_t PIN[1];		/*!< Offset 0x2100: Portpin register port n */
       uint32_t  Reserved5[31];
	__IO uint32_t MPIN[1];		/*!< Offset 0x2180: Masked port register port n */
       uint32_t  Reserved6[31];
	__IO uint32_t SET[1];		/*!< Offset 0x2200: Write: Set register for port n Read: output bits for port n */
       uint32_t  Reserved7[31];
	__O  uint32_t CLR[1];		/*!< Offset 0x2280: Clear port n */
       uint32_t  Reserved8[31];
	__O  uint32_t NOT[1];		/*!< Offset 0x2300: Toggle port n */
       uint32_t  Reserved9[31];
	__O  uint32_t DIRSET[1];	/*!< Offset 0x2380: Set direction registers port n */
       uint32_t  Reserved10[31];
	__O  uint32_t DIRCLR[1];	/*!< Offset 0x2400: Clear direction registers port n */
       uint32_t  Reserved11[31];
	__O  uint32_t DIRNOT[1];	/*!< Offset 0x2480: Toggle direction registers port n */
 ...
 */
void Chip_GPIO_SetDir(LPC_GPIO_T *pGPIO, uint8_t port, uint32_t bitValue, uint8_t out);
 ...
 */
STATIC INLINE void Chip_GPIO_SetValue(LPC_GPIO_T *pGPIO, uint8_t port, uint32_t bitValue)
{
	pGPIO->SET[port] = bitValue;
}
 ...
 */
STATIC INLINE void Chip_GPIO_ClearValue(LPC_GPIO_T *pGPIO, uint8_t port, uint32_t bitValue)
{
	pGPIO->CLR[port] = bitValue;
}
