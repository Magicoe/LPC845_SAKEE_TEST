...
/** @defgroup ADC_84X CHIP:  LPC8xx A/D conversion driver
...
typedef struct {								/*!< ADCn Structure */
  ...
  __IO uint32_t DAT[12];					/*!< A/D Channel Data Register. This register contains the result of the most recent conversion completed on channel n. */
 ...
 */
/** Newer ADC Control register bit fields */
#define ADC_CTRL_CLKDIV_P						0
#define ADC_CTRL_CLKDIV_M						(0xFF << ADC_CTRL_CLKDIV_P)
#define ADC_CTRL_CLKDIV_SET(value) 	(((uint32_t)(value) << ADC_CTRL_CLKDIV_P) & ADC_CTRL_CLKDIV_M)
#define ADC_CTRL_CLKDIV_GET(regValue)	((regValue & ADC_CTRL_CLKDIV_M) >> ADC_CTRL_CLKDIV_P)
#define ADC_CTRL_CLKDIV_LPWRMODE		(1 << 10)
#define ADC_CTRL_CLKDIV_CAL_MODE		(1 << 30)
...
#define ADC_SEQ_CTRL_HWTRIG_ADC_PINTRG0  (1 << 12)		/*!< HW trigger input - ADC_PINTRG0 */
#define ADC_SEQ_CTRL_HWTRIG_ADC_PINTRG1  (2 << 12)		/*!< HW trigger input - ADC_PINTRG1 */
#define ADC_SEQ_CTRL_HWTRIG_SCT0_OUT3    (3 << 12)		/*!< HW trigger input - SCT0_OUT3 */
#define ADC_SEQ_CTRL_HWTRIG_ACMP_O       (4 << 12)		/*!< HW trigger input - ACMP_O */
#define ADC_SEQ_CTRL_HWTRIG_ARM_TXEV     (5 << 12)		/*!< HW trigger input - ARM TXEV */
