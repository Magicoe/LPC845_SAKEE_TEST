...
#ifndef __ACMP_84X_H_
#define __ACMP_84X_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup ACMP_84X CHIP: LPC8xx Analog Comparator driver
...
typedef enum CHIP_ACMP_POS_INPUT {
	...
	ACMP_POSIN_ACMP_I0  = (1 << 8),	/*!< ACMP_I0 pin */
	ACMP_POSIN_ACMP_I1  = (2 << 8),	/*!< ACMP_I1 pin */
	ACMP_POSIN_ACMP_I2  = (3 << 8),	/*!< ACMP_I2 pin */
	ACMP_POSIN_ACMP_I3  = (4 << 8),	/*!< ACMP_I3 pin */
	ACMP_POSIN_ACMP_I4  = (5 << 8),	/*!< ACMP_I4 pin */
	ACMP_POSIN_INT_REF  = (6 << 8),	/*!< Internal reference voltage (band gap) */
	ACMP_POSIN_ADC_0	  = (7 << 8)	/*!< ADC_0 pin */
} ACMP_POS_INPUT_T;
...
typedef enum CHIP_ACMP_NEG_INPUT {
	...
	ACMP_NEGIN_ACMP_I0 = (1 << 11),	/*!< ACMP_I0 pin */
	ACMP_NEGIN_ACMP_I1 = (2 << 11),	/*!< ACMP_I1 pin */
	ACMP_NEGIN_ACMP_I2 = (3 << 11),	/*!< ACMP_I2 pin */
	ACMP_NEGIN_ACMP_I3 = (4 << 11),	/*!< ACMP_I3 pin */
	ACMP_NEGIN_ACMP_I4 = (5 << 11),	/*!< ACMP_I4 pin */
	ACMP_NEGIN_INT_REF = (6 << 11),	/*!< Internal reference voltage (band gap) */
	ACMP_NEGIN_ADC_0	 = (7 << 11)	/*!< ADC_0 pin */
} ACMP_NEG_INPUT_T;
