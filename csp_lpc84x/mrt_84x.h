...
/** @defgroup MRT_84X CHIP: LPC8xx Multi-Rate Timer driver
...
typedef enum MRT_MODE {
	...
	MRT_MODE_ONESHOTINT = (1 << 1),		/*!< MRT One-shot interrupt mode */
	MRT_MODE_ONESHOTSTALL = (2 << 1),	/*!< MRT One-shot stall mode */
} MRT_MODE_T;
...
#define MRT_INTVAL_IVALUE        (0x007FFFFFUL)	/* Maximum interval load value and mask */
#define MRT_INTVAL_IVALUE_M				(0x007FFFFFUL)	/* IVALUE mask */
#define MRT_INTVAL_IVALUE_MAX			(0x007FFFFFUL)	/* Maximum interval load value and mask */
...
#define MRT_CTRL_MODE_P					1
#define MRT_CTRL_MODE_M					(0x3UL << MRT_CTRL_MODE_P)
#define MRT_CTRL_MODE_SET(value)	(((uint32_t)(value) << MRT_CTRL_MODE_P) & MRT_CTRL_MODE_M)
