...
#ifndef __ROMAPI_84X_H_
#define __ROMAPI_84X_H_
...
/** @defgroup ROMAPI_84X CHIP: LPC84X ROM API declarations and functions
...
typedef struct {
	...
	const PWRD_API_T * pPWRD;						/*!< POWER API */
	const DIVD_API_T * pDIVD;						/*!< DIVIDER API */
...
#define LPC_ROM_API_BASE_LOC			0x0F001FF8
