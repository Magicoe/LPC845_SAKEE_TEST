...
#ifndef __PININT_84X_H_
#define __PININT_84X_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup PININT_84X CHIP: LPC8xx Pin Interrupt and Pattern Match driver
...
/**
 * LPC8xx Pin Interrupt select enum values
 */
 ...
 * means it's enabled.
 */
STATIC INLINE uint32_t Chip_PININT_GetRisingEdgeOrLevelEnabled(LPC_PIN_INT_T *pPININT)
{
    return pPININT->IENR;
}
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_PININT_EnableRisingEdgeOrLevel(LPC_PIN_INT_T *pPININT, uint32_t pins)
{
    pPININT->SIENR = pins;
}
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_PININT_DisableRisingEdgeOrLevel(LPC_PIN_INT_T *pPININT, uint32_t pins)
{
    pPININT->CIENR = pins;
}
 ...
 */
STATIC INLINE uint32_t Chip_PININT_GetFallingEdgeOrLevelEnabled(LPC_PIN_INT_T *pPININT)
{
    return pPININT->IENF;
}
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_PININT_EnableFallingEdgeOrLevel(LPC_PIN_INT_T *pPININT, uint32_t pins)
{
    pPININT->SIENF = pins;
}
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_PININT_DisableFallingEdgeOrLevel(LPC_PIN_INT_T *pPININT, uint32_t pins)
{
    pPININT->CIENF = pins;
}
