...
/** @defgroup PMU_84X CHIP: LPC8xx PMU driver
 ...
 */
#define PMU_DPDCTRL_WAKEUPPHYS      (1 << 0)	/** Enable WAKEUP pin hysteresis */
#define PMU_DPDCTRL_WAKEUPPAD       (1 << 1)	/** Disable WAKEUP function */
...
#define PMU_DPDCTRL_WKTCLKINPHYS    (1 << 4)	/** Enable WKTCLKIN pin hysteresis */
#define PMU_DPDCTRL_WKTCLKINPAD     (1 << 5)	/** Enable WKTVLKIN function */
