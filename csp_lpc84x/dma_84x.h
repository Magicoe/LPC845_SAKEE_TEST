...
/** @defgroup DMA_84X CHIP: LPC8xx DMA Controller driver
...
typedef enum {
	...
	DMAREQ_USART3_RX,					/*!< USART1 receive DMA channel */
	DMA_CH6 = DMAREQ_USART3_RX,
	DMAREQ_USART3_TX,					/*!< USART1 transmit DMA channel */
	DMA_CH7 = DMAREQ_USART3_TX,
	DMAREQ_USART4_RX,					/*!< USART2 receive DMA channel */
	DMA_CH8 = DMAREQ_USART4_RX,
	DMAREQ_USART4_TX,					/*!< USART2 transmit DMA channel */
	DMA_CH9 = DMAREQ_USART4_TX,
	DMAREQ_SPI0_RX,						/*!< SPI0 receive DMA channel */
	DMA_CH10 = DMAREQ_SPI0_RX,
	DMAREQ_SPI0_TX,						/*!< SPI0 transmit DMA channel */
	DMA_CH11 = DMAREQ_SPI0_TX,
	DMAREQ_SPI1_RX,						/*!< SPI1 receive DMA channel */
	DMA_CH12 = DMAREQ_SPI1_RX,
	DMAREQ_SPI1_TX,						/*!< SPI1 transmit DMA channel */
	DMA_CH13 = DMAREQ_SPI1_TX,
	DMAREQ_I2C0_SLAVE,					/*!< I2C0 Slave DMA channel */
	DMA_CH14 = DMAREQ_I2C0_SLAVE,
	DMAREQ_I2C0_MASTER,					/*!< I2C0 Master DMA channel */
	DMA_CH15 = DMAREQ_I2C0_MASTER,
	DMAREQ_I2C1_SLAVE,					/*!< I2C1 Slave DMA channel */
	DMA_CH16 = DMAREQ_I2C1_SLAVE,
	DMAREQ_I2C1_MASTER,					/*!< I2C1 Master DMA channel */
	DMA_CH17 = DMAREQ_I2C1_MASTER,
	DMAREQ_I2C2_SLAVE,					/*!< I2C2 Slave DMA channel */
	DMA_CH18 = DMAREQ_I2C2_SLAVE,
	DMAREQ_I2C2_MASTER,					/*!< I2C2 Master DMA channel */
	DMA_CH19 = DMAREQ_I2C2_MASTER,
	DMAREQ_I2C3_SLAVE,					/*!< I2C3 Slave DMA channel */
	DMA_CH20 = DMAREQ_I2C3_SLAVE,
	DMAREQ_I2C3_MASTER,					/*!< I2C3 Master DMA channel */
	DMA_CH21 = DMAREQ_I2C3_MASTER,
	DMAREQ_DAC0,								/*!< DAC0 DMA channel */
	DMA_CH22 = DMAREQ_DAC0,
	DMAREQ_DAC1,								/*!< DAC1 DMA channel */
	DMA_CH23 = DMAREQ_DAC1,
	DMAREQ_CAPT,								/*!< CAPT DMA channel */
	DMA_CH24 = DMAREQ_CAPT,
} DMA_CHID_T;

/* On LPC84x, Max DMA channel is 25 */
#define DMA_CHANNELS			(DMA_CH24+1)
#define RELOAD_DESC_ENTRIES		0
...
typedef struct {					/*!< DMA Structure */
	...
	LPC_DMA_CHANNEL_T CHANNEL[DMA_CHANNELS];	/*!< DMA channel registers */
} LPC_DMA_T;
...
/* DMA reload source/address/next descriptor */
typedef struct {
	uint32_t  xfercfg;	/*!< DMA transfer transfer configuration */
	uint32_t  source;		/*!< DMA transfer source end address */
	uint32_t  dest;			/*!< DMA transfer desintation end address */
	uint32_t  next;			/*!< Link to next DMA descriptor, must be 16 byte aligned */
} DMA_RELOADDESC_T;
...
#define DMA_INTSTAT_ACTIVEINT      (1 << 1)		/*!< Summarizes whether any enabled interrupts are pending */
#define DMA_INTSTAT_ACTIVEERRINT   (1 << 2)		/*!< Summarizes whether any error interrupts are pending */
...
#define DMA_CFG_BURSTPPOWER_P 			8
#define DMA_CFG_BURSTPPOWER_M 			(0xFUL << DMA_CFG_BURSTPPOWER_P)
#define DMA_CFG_BURSTPPOWER_SET(value)	(((uint32_t)(value) << DMA_CFG_BURSTPPOWER_P) & DMA_CFG_BURSTPPOWER_M)
#define DMA_CFG_BURSTPPOWER_GET(regValue)	((regValue & DMA_CFG_BURSTPPOWER_M) >> DMA_CFG_BURSTPPOWER_P)
...
#define DMA_CFG_CHPRIORITY_P 			16
#define DMA_CFG_CHPRIORITY_M 			(0x7UL << DMA_CFG_CHPRIORITY_P)
#define DMA_CFG_CHPRIORITY_SET(value)	(((uint32_t)(value) << DMA_CFG_CHPRIORITY_P) & DMA_CFG_CHPRIORITY_M)

#define DMA_CTLSTAT_VALIDPENDING 		(1 << 0)
#define DMA_CTLSTAT_TRIGGERRED 			(1 << 2)
...
#define DMA_XFERCFG_WIDTH_M					(0x3UL << DMA_XFERCFG_WIDTH_P)
#define DMA_XFERCFG_WIDTH_SET(value) 	(((uint32_t)(value) << DMA_XFERCFG_WIDTH_P) & DMA_XFERCFG_WIDTH_M)
#define DMA_XFERCFG_WIDTH_GET(regValue)	((regValue & DMA_XFERCFG_WIDTH_M) >> DMA_XFERCFG_WIDTH_P)
...
#define DMA_XFERCFG_SRCINC_P 				12
#define DMA_XFERCFG_SRCINC_M 				(1UL << DMA_XFERCFG_SRCINC_P)
#define DMA_XFERCFG_SRCINC_SET(value) 	(((uint32_t)(value) << DMA_XFERCFG_SRCINC_P) & DMA_XFERCFG_SRCINC_M)
#define DMA_XFERCFG_SRCINC_GET(regValue) 		((regValue & DMA_XFERCFG_SRCINC_M) >> DMA_XFERCFG_SRCINC_P)
...
#define DMA_XFERCFG_DSTINC_M 				(1UL << DMA_XFERCFG_DSTINC_P)
#define DMA_XFERCFG_DSTINC_SET(value) (((uint32_t)(value) << DMA_XFERCFG_DSTINC_P) & DMA_XFERCFG_DSTINC_M)
#define DMA_XFERCFG_DSTINC_GET(regValue) 		((regValue & DMA_XFERCFG_DSTINC_M) >> DMA_XFERCFG_DSTINC_P)
#define DMA_XFERCFG_XFERCOUNT(n)    ((n - 1) << 16)	/*!< DMA transfer count in 'transfers', between (0)1 and (1023)1024 */
#define DMA_XFERCFG_XFERCOUNT_MINUS1_P			16
#define DMA_XFERCFG_XFERCOUNT_MINUS1_M			(0x3FFUL << DMA_XFERCFG_XFERCOUNT_MINUS1_P)
#define DMA_XFERCFG_XFERCOUNT_MINUS1_SET(value)		((((uint32_t)(value)) << DMA_XFERCFG_XFERCOUNT_MINUS1_P) & DMA_XFERCFG_XFERCOUNT_MINUS1_M)
#define DMA_XFERCFG_XFERCOUNT_MINUS1_GET(regValue) 	((regValue & DMA_XFERCFG_XFERCOUNT_MINUS1_M) >> DMA_XFERCFG_XFERCOUNT_MINUS1_P)
...
// Interrupt A or B handlers for specific DMA channels use this declaration
typedef void (*DMA_ChannelInterruptHandler)(uint8_t dmaChannel);
...
extern volatile DMA_CHDESC_T Chip_DMA_Table[DMA_CHANNELS];

#if RELOAD_DESC_ENTRIES
extern volatile DMA_RELOADDESC_T Chip_DMA_ReloadDescTable[RELOAD_DESC_ENTRIES];
#endif
...
/** @defgroup DMA_COMMON_84X CHIP: LPC8xx DMA Controller driver common functions
 * @{
 */
...
/** @defgroup DMA_COMMON_84X CHIP: LPC8xx DMA Controller driver common channel functions
 * @{
 */
 ...
 * @param	pDMA	: The base of DMA controller on the chip
 * @return	An Or'ed value of all enabled DMA channels
 * @note	A high values in bit of the return values indicates
 ...
 * @param	pDMA	: The base of DMA controller on the chip
 * @return	An Or'ed value of all active DMA channels
 * @note	A high values in bit of the return values indicates
 *			that the channel for that bit (bit 0 = channel 0, bit 1 -
 ...
 * @param	pDMA	: The base of DMA controller on the chip
 * @return	An Or'ed value of all busy DMA channels
 * @note	A high values in bit of the return values indicates
 *			that the channel for that bit (bit 0 = channel 0, bit 1 -
 ...
 * @param	pDMA	: The base of DMA controller on the chip
 * @return	An Or'ed value of all channels error interrupt status
 * @note	A high values in bit of the return values indicates
 *			that the channel for that bit (bit 0 = channel 0, bit 1 -
...
/** @defgroup DMA_CHANNEL_84X CHIP: LPC8xx DMA Controller driver channel specific functions
 * @{
 */
...
{
	return pDMA->CHANNEL[ch].CTLSTAT;
}
...
void Chip_DMA_SetAndEnable(uint32_t dmaChannel, DMA_CHDESC_T *pDMAChDesc, uint32_t xfercfg, uint32_t chCFG,
