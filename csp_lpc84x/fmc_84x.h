...
/** @defgroup FMC_84X CHIP: LPC8xx FLASH Memory Controller driver
...
typedef enum {
	/* FIXME */
	FLASHTIM_WS_0 = 0,	/*!< Flash accesses use 1 CPU clocks. Use for up to 20 MHz CPU clock*/
	FLASHTIM_WS_1 = 1, 	/*!< Flash accesses use 2 CPU clocks. Use for up to 30 MHz CPU clock*/
	FLASHTIM_WS_2 = 2, 	/*!< Flash accesses use 3 CPU clocks. Use for up to 30 MHz CPU clock*/
	FLASHTIM_WS_3 = 3, 	/*!< Flash accesses use 4 CPU clocks. Use for up to 30 MHz CPU clock*/
} FMC_FLASHTIM_T;
